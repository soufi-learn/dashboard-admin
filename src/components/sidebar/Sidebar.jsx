...
const Sidebar = () => {
  return (
    <div className="hidden lg:block z-10 md:w-2/5 lg:w-1/4 xl:w-1/5 min-h-[93vh] sticky top-6 p-3 transition-all rounded-lg bg-light-darker text-dark-main dark:text-light-main dark:bg-dark-lighter shadow-md">
