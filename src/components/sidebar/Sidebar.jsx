...
const Sidebar = () => {
  return (
    <div className="hidden w-1/5 min-h-[94vh] sticky top-6 p-3 transition-all rounded-lg bg-light-darker text-dark-main dark:text-light-main dark:bg-dark-lighter">
